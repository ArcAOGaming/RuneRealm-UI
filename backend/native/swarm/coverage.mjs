...
export const LIVED_IN_REQUIREMENTS = Object.freeze([
  ...
  { id: 'pve-round', label: 'PvE battle round played', prefer: 'bot', match: /^battle\.attack\.bot$/ },
  ...
  { id: 'pvp-round', label: 'both sides of PvP rounds played', match: /^battle\.attack\.pvp$/ },
  ...
  { id: 'arbitrage', label: 'P2P/NPC arbitrage leg executed', prefer: 'arbitrage', match: /^arbitrage\./ },
