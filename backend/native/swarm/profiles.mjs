...
export const ROLE_DEFINITIONS = Object.freeze({
  ...
  arena: {
    ...
    weights: { daily: 4, quest: 0, loot: 3, feed: 5, play: 1, hunt: 4, bot: 14, store: 2, retrieve: 3, swap: 4, list: 1, buy: 2, cancel: 1, give: 1, goods_make: 2, goods_amend: 3, goods_take: 8, goods_cancel: 2, goods_cancel_all: 1, goods_maintain: 1, shop_trade: 8, arbitrage: 4, venue_internal: 3, venue_external: 3, probe: 4, withdraw: 1, deposit: 1 },
    statPlan: { attack: 3, defense: 2, speed: 3, health: 2 },
    botDifficulty: 1.2,
  },
  duelist: {
    label: 'PvP duelist',
    weights: { daily: 5, quest: 0, loot: 2, feed: 6, play: 2, hunt: 0, bot: 0, store: 2, retrieve: 2, swap: 3, list: 1, buy: 1, cancel: 1, give: 1, goods_make: 2, goods_amend: 3, goods_take: 7, goods_cancel: 2, goods_cancel_all: 1, goods_maintain: 1, shop_trade: 8, arbitrage: 4, venue_internal: 2, venue_external: 2, probe: 3, withdraw: 0, deposit: 0 },
    statPlan: { attack: 3, defense: 2, speed: 3, health: 2 },
    botDifficulty: 1,
  },
  collector: {
